  ...
  <main id="main">
    ...
    <section class="mx-auto max-w-7xl px-5 py-14 sm:px-8">
      <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <a href="${base}dashboard/book-classes.html" class="btn-primary shrink-0">${icon("calendar","h-4 w-4")} Book a Class</a>
      </div>
        ...
        <div data-tab-panel="all" class="card overflow-hidden">
          ...
          <div class="p-5">
            ...
            <div class="mt-5 flex items-center gap-2">
              <a href="${base}class-details.html" class="btn-outline btn-sm flex-1">Details</a>
              <a href="${base}dashboard/book-classes.html" class="btn-primary btn-sm flex-1">Reserve</a>
            </div>
          </div>
        </div>`).join("")}
      </div>
